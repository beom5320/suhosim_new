...
import nodomain.team3point1.suhosim.export.ActivityTrackExporter;
...
//        }
        ...
        if (success) {
            ...
            try {
                ...
                String fileName = FileUtils.makeValidFileName("suhosim-"+trackType.toLowerCase()+"-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
