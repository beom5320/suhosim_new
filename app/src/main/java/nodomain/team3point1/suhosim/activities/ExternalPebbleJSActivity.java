...
import nodomain.team3point1.suhosim.service.devices.pebble.webview.GBChromeClient;
import nodomain.team3point1.suhosim.service.devices.pebble.webview.GBWebClient;
import nodomain.team3point1.suhosim.service.devices.pebble.webview.JSInterface;
...
public class ExternalPebbleJSActivity extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            if(confUri.getScheme().equals("suhosim")) {
                try {
