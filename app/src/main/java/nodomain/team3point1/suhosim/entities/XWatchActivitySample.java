 ...
 */
public class XWatchActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    public XWatchActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public XWatchActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int rawIntensity, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getXWatchActivitySampleDao() : null;
    }
