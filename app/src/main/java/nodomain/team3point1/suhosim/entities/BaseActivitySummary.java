 ...
 */
public class BaseActivitySummary implements nodomain.team3point1.suhosim.model.ActivitySummary {
    ...
    public BaseActivitySummary(Long id, String name, java.util.Date startTime, java.util.Date endTime, int activityKind, Integer baseLongitude, Integer baseLatitude, Integer baseAltitude, String gpxTrack, long deviceId, long userId) {
        this.id = id;
        this.name = name;
