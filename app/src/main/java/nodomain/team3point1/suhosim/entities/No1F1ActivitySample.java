 ...
 */
public class No1F1ActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient No1F1ActivitySampleDao myDao;
    ...
    public No1F1ActivitySample() {
    }

    public No1F1ActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public No1F1ActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int rawIntensity, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getNo1F1ActivitySampleDao() : null;
    }
