...
/**
 * Entity mapped to table "HPLUS_HEALTH_ACTIVITY_OVERLAY".
 */
public class HPlusHealthActivityOverlay {
    ...
    public HPlusHealthActivityOverlay(int timestampFrom, int timestampTo, int rawKind, long deviceId) {
    ...
    public HPlusHealthActivityOverlay(int timestampFrom, int timestampTo, int rawKind, long deviceId, long userId, byte[] rawHPlusHealthData) {
        this.timestampFrom = timestampFrom;
        this.timestampTo = timestampTo;
        this.rawKind = rawKind;
        this.deviceId = deviceId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getHPlusHealthActivityOverlayDao() : null;
    }
