...
/** 
 * DAO for table "XWATCH_ACTIVITY_SAMPLE".
*/
public class XWatchActivitySampleDao extends AbstractDao<XWatchActivitySample, Void> {

    public static final String TABLENAME = "XWATCH_ACTIVITY_SAMPLE";

    /**
     * Properties of entity XWatchActivitySample.<br/>
    ...
    */
    ...
    public XWatchActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public XWatchActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"XWATCH_ACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"XWATCH_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, XWatchActivitySample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(XWatchActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public XWatchActivitySample readEntity(Cursor cursor, int offset) {
        XWatchActivitySample entity = new XWatchActivitySample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, XWatchActivitySample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(XWatchActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(XWatchActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM XWATCH_ACTIVITY_SAMPLE T");
    ...
    protected XWatchActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        XWatchActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public XWatchActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<XWatchActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<XWatchActivitySample> list = new ArrayList<XWatchActivitySample>(count);
    ...
    protected List<XWatchActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<XWatchActivitySample> queryDeep(String where, String... selectionArg) {
