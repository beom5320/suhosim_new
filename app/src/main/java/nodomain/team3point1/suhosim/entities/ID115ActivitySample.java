 ...
 */
public class ID115ActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient ID115ActivitySampleDao myDao;
    ...
    public ID115ActivitySample() {
    }

    public ID115ActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public ID115ActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, Integer caloriesBurnt, Integer distanceMeters, Integer activeTimeMinutes) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getID115ActivitySampleDao() : null;
    }
