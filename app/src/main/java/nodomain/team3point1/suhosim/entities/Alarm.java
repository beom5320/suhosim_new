 ...
 */
public class Alarm implements nodomain.team3point1.suhosim.model.Alarm {
    ...
    public Alarm(long deviceId, long userId, int position, boolean enabled, boolean smartWakeup, int repetition, int hour, int minute) {
