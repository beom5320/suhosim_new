 ...
 */
public class ZeTimeActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient ZeTimeActivitySampleDao myDao;
    ...
    public ZeTimeActivitySample() {
    }

    public ZeTimeActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public ZeTimeActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int rawIntensity, int heartRate, Integer caloriesBurnt, Integer distanceMeters, Integer activeTimeMinutes) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getZeTimeActivitySampleDao() : null;
    }
