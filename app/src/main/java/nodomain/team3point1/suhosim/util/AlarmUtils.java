...
public class AlarmUtils {
     ...
     * @return
     */
    public static nodomain.team3point1.suhosim.model.Alarm createSingleShot(int index, boolean smartWakeup, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(nodomain.team3point1.suhosim.model.Alarm alarm) {
