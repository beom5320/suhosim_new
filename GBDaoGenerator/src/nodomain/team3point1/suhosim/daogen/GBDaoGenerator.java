 ...
 */
package nodomain.team3point1.suhosim.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "nodomain.team3point1.suhosim";
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("nodomain.team3point1.suhosim.model.Alarm");
